...
headline = Label(Clock, text="** Digital Clock **", font=("Times New Roman", 24, "bold"), bg="black", fg="white")
...
lab_year_txt = Label(Clock, text="Year", font=("Times New Roman", 20, "bold"), bg="black", fg="white")
